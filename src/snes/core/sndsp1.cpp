...
void SNDSP1::Execute(Uint8 uCmd)
{
    ...
    case 0x06: case 0x16: case 0x26: case 0x36: {  // Project
        ...
        // O NormalizeDouble devolve expoentes positivos grandes (~19),
        // entao sem esta reatribuicao o expoente final fica positivo e
        // o DenormalizeAndClip satura H/V em +-32767 (objetos somem da
        // tela).  Confirmado via bancada de teste host-side (Project
        // saturava sem esta linha).
        {
