...
{
public:
    PceSystem();virtual ~PceSystem();virtual void SetRom(Emu::Rom*);Bool LoadDisc(const Char*,const Char*);/* AURORA_CD_SRAM_NOTICES_20260824 */virtual void Reset();virtual void SoftReset();
