    ...
    if (dir != 0)
    {
        ...
        case 28: 
            { 
                ...
                if (level < 0) level = SNPPU_LIMIT_NUM - 1; // Ajustado para a constante exata de limite do emulador
        ...
        case 29: 
            { 
                ...
                if (mode < 0) mode = SNPPU_LIMIT_MODE_NUM - 1; // Ajustado para a constante de modo correta
